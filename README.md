...
POS_BusinessLayer: Contains business rules and entities (e.g., clsProduct.cs, clsInvoice.cs).

POS_DataAccessLayer: Handles all direct database communication and SQL commands.
